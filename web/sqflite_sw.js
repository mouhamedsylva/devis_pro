...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _handleMessageEvent($event) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], port, command, data, key, value, data0, key0, value0, ffiMethodCall, postResponse, result, e, st, e0, st0, exception, t2, t3, error, t1, rawData, $async$exception, $async$exception1;
    ...
    sqfliteFfiWebLoadSqlite3Wasm(options, fromWebWorker) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.SqfliteFfiWebContext),
        $async$returnValue, uri, fs, wasmSqlite3, t1, $name, t2, t3, ptr, context;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              ...
              t2 = t1.callbacks;
              t3 = t2._id++;
              t2.registeredVfs.$indexSet(0, t3, fs);
              ptr = A._asInt(t1.sqlite3.dart_sqlite3_register_vfs($name, t3, 1));
              if (ptr === 0)
    ...
    SqliteException$(extendedResultCode, message, explanation, causingStatement, parametersToStatement, operation, offset) {
    ...
    FinalizableDatabase: function FinalizableDatabase(t0, t1, t2, t3) {
      var _ = this;
      _.bindings = t0;
      _.database = t1;
      _._statements = t2;
    ...
    WasmInstance_load(response, imports) {
      var $async$goto = 0,
        ...
        $async$returnValue, native, exports, _this;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.WebAssembly.instantiateStreaming(response, _this)), type$.JSObject), $async$WasmInstance_load);
            case 3:
              // returning from await.
              native = $async$result;
              exports = A._asJSObject(A._asJSObject(native.instance).exports);
              if ("_initialize" in exports)
                type$.JavaScriptFunction._as(exports._initialize).call();
              $async$returnValue = A._asJSObject(native.instance);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    WasmBindings_instantiateAsync(response) {
      var $async$goto = 0,
        ...
        $async$returnValue, instance, injected, t1;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$returnValue = injected.___InjectedValues_bindings_A = new A.WasmBindings(t1, injected.callbacks, A._asJSObject(instance.exports));
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _InjectedValues_closure27: function _InjectedValues_closure27(t0) {
      this.memory = t0;
    },
    _InjectedValues_closure28: function _InjectedValues_closure28(t0) {
      this.$this = t0;
    },
    _InjectedValues_closure29: function _InjectedValues_closure29(t0) {
      this.$this = t0;
    },
    DartCallbacks: function DartCallbacks(t0, t1, t2, t3, t4) {
      var _ = this;
      _._id = 0;
      _.functions = t0;
    ...
    createExceptionRaw(bindings, db, returnCode, operation, previousStatement, statementArgs) {
      var t5,
        ...
        t4 = type$.nullable_JavaScriptFunction._as(t3.sqlite3_error_offset),
        _0_0 = t4 == null ? null : A._asInt(A._asDouble(t4.call(null, t2)));
      if (_0_0 == null)
        _0_0 = -1;
      $label0$0: {
        if (_0_0 < 0) {
  ...
  A.FinalizableDatabase.prototype = {
    dispose$0() {
      var t1, t2, _i, stmt, t3, code, exception, _this = this;
      for (t1 = _this._statements, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        stmt = t1[_i];
        if (!stmt._closed) {
          stmt._closed = true;
          ...
          A._asInt(t3.bindings.sqlite3.sqlite3_finalize(t3.stmt));
        }
      }
      t1 = _this.dartCleanup;
      ...
      for (; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        t1[_i].call$0();
      t1 = _this.database;
      code = A._asInt(t1.bindings.sqlite3.sqlite3_close_v2(t1.db));
  ...
  A.DatabaseImplementation.prototype = {
    dispose$0() {
      var t1, t2, t3, _this0, t4, _this = this;
      if (_this._isClosed)
        return;
      ...
      t2 = t1.bindings;
      t3 = t2.callbacks;
      t3.set$installedUpdateHook(null);
      _this0 = t1.db;
      t1 = t2.sqlite3;
      t2 = type$.nullable_JavaScriptFunction;
      t4 = t2._as(t1.dart_sqlite3_updates);
      if (t4 != null)
        t4.call(null, _this0, -1);
      t3.set$installedCommitHook(null);
      t4 = t2._as(t1.dart_sqlite3_commits);
      if (t4 != null)
        t4.call(null, _this0, -1);
      t3.set$installedRollbackHook(null);
      t1 = t2._as(t1.dart_sqlite3_rollbacks);
      if (t1 != null)
        t1.call(null, _this0, -1);
      ...
      for (t1 = this.createdStatements, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i) {
        ...
        if (!t3._closed) {
          ...
          if (!t3._closed) {
            ...
            if (!t3._inResetState) {
              t4 = t3.statement;
              A._asInt(t4.bindings.sqlite3.sqlite3_reset(t4.stmt));
              t3._inResetState = true;
            }
            t4 = t3.statement;
            t4.deallocateArguments$0();
            A._asInt(t4.bindings.sqlite3.sqlite3_finalize(t4.stmt));
          }
          t4 = stmt.database;
          if (!t4._isClosed)
  ...
  A.Sqlite3Implementation.prototype = {
    open$2$mode(filename, mode) {
      var flags, namePtr, t3, outDb, result, t4, t5, dbPtr, exception, _null = null,
        t1 = this.bindings,
        t2 = t1.bindings,
        rc = t2.sqlite3_initialize$0();
      if (rc !== 0)
        A.throwExpression(A.SqliteException$(rc, "Error returned by sqlite3_initialize", _null, _null, _null, _null, _null));
      switch (mode) {
        case B.OpenMode_0:
          flags = 1;
          break;
      ...
      t2 = new A.WasmDatabase(t2, dbPtr);
      if (result !== 0) {
        exception = A.createExceptionRaw(t1, t2, result, "opening the database", _null, _null);
        A._asInt(t3.sqlite3_close_v2(dbPtr));
        throw A.wrapException(exception);
      }
      A._asInt(t3.sqlite3_extended_result_codes(dbPtr, 1));
      t3 = new A.FinalizableDatabase(t1, t2, A._setArrayType([], type$.JSArray_FinalizableStatement), A._setArrayType([], type$.JSArray_of_void_Function));
      t2 = new A.DatabaseImplementation(t1, t2, t3);
      t1 = $.$get$disposeFinalizer();
  ...
  A.FinalizableStatement.prototype = {
    dispose$0() {
      ...
      if (!_this._closed) {
        ...
        A._asInt(t1.bindings.sqlite3.sqlite3_finalize(t1.stmt));
      }
    },
    _reset$0() {
  ...
  A.StatementImplementation.prototype = {
    ...
    _bindParam$2(param, i) {
      var t1, _this0, encoded, t2, ptr, _this = this;
      $label0$0: {
        if (param == null) {
          t1 = _this.statement;
        ...
        if (typeof param == "string") {
          ...
          t1 = A.callMethod(t2.sqlite3, "sqlite3_bind_text", [t1.stmt, i, ptr, encoded.length, 0], type$.int);
          break $label0$0;
        }
        t1 = type$.List_int;
        if (t1._is(param)) {
          ...
          t2 = A.callMethod(t1.sqlite3, "sqlite3_bind_blob64", [t2.stmt, i, ptr, type$.JavaScriptBigInt._as(init.G.BigInt(J.get$length$asx(param))), 0], type$.int);
          t1 = t2;
          break $label0$0;
        }
  ...
  A.WasmStatementCompiler.prototype = {
    ...
    sqlite3_prepare$3(byteOffset, $length, prepFlag) {
      ...
      return new A.SqliteResult(t1, libraryStatement, type$.SqliteResult_nullable_RawSqliteStatement);
    }
  };
  A.WasmStatement.prototype = {
    deallocateArguments$0() {
      var t1, t2, t3, _i;
      for (t1 = this._allocatedArguments, t2 = t1.length, t3 = this.bindings.sqlite3, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
        t3.dart_sqlite3_free(t1[_i]);
  ...
  A.WasmBindings.prototype = {
    ...
    sqlite3_initialize$0() {
      var t1,
        _0_0 = type$.nullable_JavaScriptFunction._as(this.sqlite3.sqlite3_initialize);
      $label0$0: {
        if (_0_0 != null) {
          t1 = A._asInt(A._asDouble(_0_0.call(null)));
          break $label0$0;
        }
        t1 = 0;
        break $label0$0;
    ...
    sqlite3_db_config$3(db, op, value) {
      var $function = type$.nullable_JavaScriptFunction._as(this.sqlite3.dart_sqlite3_db_config_int);
      if ($function != null)
  ...
  A._InjectedValues__closure13.prototype = {
    call$0() {
      var t3, t4, t5, _this = this,
        ...
        t1 = _this.$this.callbacks,
        t2 = t1._id++;
      t1.openedFiles.$indexSet(0, t2, result._0);
      t1 = _this.memory;
      t3 = type$.NativeArrayBuffer;
      t4 = A.NativeInt32List_NativeInt32List$view(t3._as(t1.buffer), 0, null);
      t5 = B.JSInt_methods._shrOtherPositive$1(_this.dartFdPtr, 2);
      ...
      t2 = _this.pOutFlags;
      if (t2 !== 0) {
        t1 = A.NativeInt32List_NativeInt32List$view(t3._as(t1.buffer), 0, null);
        t2 = B.JSInt_methods._shrOtherPositive$1(t2, 2);
        t1.$flags & 2 && A.throwUnsupportedOperation(t1);
        if (!(t2 < t1.length))
          return A.ioore(t1, t2);
        t1[t2] = result._1;
  ...
  A._InjectedValues__closure11.prototype = {
    call$0() {
      var _this = this,
        ...
        t1 = A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), 0, null),
  ...
  A._InjectedValues__closure10.prototype = {
    call$0() {
      ...
      if (t1 > _this.nOut)
        throw A.wrapException(A.VfsException$(14));
      t2 = A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), 0, null);
      t3 = _this.zOut;
  ...
  A._InjectedValues_closure4.prototype = {
    call$3(vfsId, nByte, zOut) {
      A._asInt(vfsId);
      A._asInt(nByte);
      return A._runVfs(new A._InjectedValues__closure9(this.memory, A._asInt(zOut), nByte, this.$this.callbacks.registeredVfs.$index(0, vfsId)));
    },
    $signature: 11
  };
  A._InjectedValues__closure9.prototype = {
    call$0() {
      var _this = this,
        target = A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), _this.zOut, _this.nByte),
        t1 = _this.vfs;
      if (t1 != null)
  ...
  A._InjectedValues__closure6.prototype = {
    call$0() {
      var _this = this;
      _this.file.xRead$2(A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), _this.target, _this.amount), A._asInt(A._asDouble(init.G.Number(_this.offset))));
    },
    $signature: 0
  };
  ...
  A._InjectedValues__closure5.prototype = {
    call$0() {
      var _this = this;
      _this.file.xWrite$2(A.NativeUint8List_NativeUint8List$view(type$.NativeArrayBuffer._as(_this.memory.buffer), _this.source, _this.amount), A._asInt(A._asDouble(init.G.Number(_this.offset))));
    },
    $signature: 0
  };
  ...
  A._InjectedValues__closure2.prototype = {
    call$0() {
      var size = this.file.xFileSize$0(),
        t1 = A.NativeInt32List_NativeInt32List$view(type$.NativeArrayBuffer._as(this.memory.buffer), 0, null),
  ...
  A._InjectedValues_closure17.prototype = {
    call$3(ctx, args, value) {
      ...
      t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).get$xFunc().call$2(new A.WasmContext(), new A.WasmValueList(t1.___InjectedValues_bindings_A, args, value));
    },
    $signature: 14
  };
  A._InjectedValues_closure18.prototype = {
    call$3(ctx, args, value) {
      ...
      t2 = t1.___InjectedValues_bindings_A;
      t2 === $ && A.throwLateFieldNI("bindings");
      t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).get$xStep().call$2(new A.WasmContext(), new A.WasmValueList(t1.___InjectedValues_bindings_A, args, value));
    },
    $signature: 14
  };
  A._InjectedValues_closure19.prototype = {
    call$3(ctx, args, value) {
      ...
      t2 = t1.___InjectedValues_bindings_A;
      t2 === $ && A.throwLateFieldNI("bindings");
      t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).get$xInverse().call$2(new A.WasmContext(), new A.WasmValueList(t1.___InjectedValues_bindings_A, args, value));
    },
    $signature: 14
  };
  A._InjectedValues_closure20.prototype = {
    call$1(ctx) {
      ...
      t2 = t1.___InjectedValues_bindings_A;
      t2 === $ && A.throwLateFieldNI("bindings");
      t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).get$xFinal().call$1(new A.WasmContext());
    },
    $signature: 6
  };
  A._InjectedValues_closure21.prototype = {
    call$1(ctx) {
      ...
      t2 = t1.___InjectedValues_bindings_A;
      t2 === $ && A.throwLateFieldNI("bindings");
      t1.callbacks.functions.$index(0, A._asInt(t2.sqlite3.sqlite3_user_data(ctx))).get$xValue().call$1(new A.WasmContext());
    },
    $signature: 6
  };
  ...
  A._InjectedValues_closure27.prototype = {
    call$2(timestamp, resultPtr) {
      var time, dateTime, tmValues, t1, t2;
      ...
      tmValues = A.NativeUint32List_NativeUint32List$view(type$.NativeArrayBuffer._as(this.memory.buffer), resultPtr, 8);
  ...
  A._InjectedValues_closure28.prototype = {
    call$2(context, zTab) {
      A._asInt(context);
      A._asInt(zTab);
      return this.$this.callbacks.sessionApply.$index(0, context).get$filter().call$1(zTab);
    },
    $signature: 1
  };
  A._InjectedValues_closure29.prototype = {
    call$3(context, eConflict, iter) {
      A._asInt(context);
      A._asInt(eConflict);
      A._asInt(iter);
      return this.$this.callbacks.sessionApply.$index(0, context).get$conflict().call$2(eConflict, iter);
    },
    $signature: 11
  };
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "int(int,int)", "Future<~>()", "~(JSObject)", "Null()", "Future<@>()", "Null(int)", "~(@)", "~(@,@)", "Null(JSObject)", "~(~())", "int(int,int,int)", "int(int)", "Future<@>(SqfliteFfiDatabase)", "Null(int,int,int)", "Future<Map<@,@>>()", "@()", "Future<Null>()", "Future<Object?>()", "Null(@)", "int(int,int,int,int,int)", "int(int,int,int,int)", "int(int,int,int,JavaScriptBigInt)", "SqfliteFfiException(@)", "Null(@,StackTrace)", "~(String,int)", "Future<int?>()", "Future<int>()", "~(String,int?)", "~(int,@)", "Map<String,Object?>(SqfliteFfiException)", "~(@[@])", "bool(String)", "int?()", "Map<@,@>(int)", "~(Map<@,@>)", "~(Object,StackTrace)", "Future<Object?>(SqfliteFfiDatabase)", "Future<int?>(SqfliteFfiDatabase)", "Future<int>(SqfliteFfiDatabase)", "Future<bool>()", "~(FfiMethodResponse)", "Null(~())", "MapEntry<String,_BigIntAdapter>(int,_BigIntAdapter)", "String(String)", "~(FinalizablePart)", "@(@,String)", "~(String,Map<String,Object?>)", "@(String)", "JSObject(JSObject?)", "Future<~>(int,Uint8List)", "Future<~>(int)", "Uint8List()", "~(Object?,Object?)", "String(String?)", "String(Object?)", "String?(Object?)", "Null(int,int)", "@(@)", "int(int,JavaScriptBigInt)", "int?(String)", "Null(int,int,int,int,JavaScriptBigInt)", "int?(int)", "Null(JavaScriptBigInt,int)", "int(@,@)", "~(String,Object?)", "Null(Object,StackTrace)"],
